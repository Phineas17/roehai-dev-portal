...
export function WebhookExpressGuide() {
  return (
    <div className="max-w-3xl">
      <div className="mb-8">
        <div className="text-xs text-[#a09dc0] mb-2">Guides → Webhook</div>
        <h1 className="text-3xl font-bold text-white mb-2">Webhook avec Express.js</h1>
      ...
      <div className="flex flex-col gap-8">
        <section>
          <h2 className="text-xl font-semibold text-white mb-2">1. Installer les dépendances</h2>
          <CodeBlock code={installDeps} language="bash" />
        </section>

        <section>
          <h2 className="text-xl font-semibold text-white mb-2">2. Serveur complet</h2>
          <CodeBlock code={fullExample} language="typescript" filename="webhook-server.ts" />
        </section>

        <section>
          <h2 className="text-xl font-semibold text-white mb-2">3. Tester en local</h2>
        ...
        <div className="p-4 rounded-xl bg-[#1a1a35] border border-white/8 text-sm">
          <p className="text-white font-medium mb-2">Points importants</p>
          <ul className="text-[#a09dc0] space-y-1.5">
            <li>→ Répondez toujours <code className="text-purple-300 bg-purple-900/20 px-1 rounded text-xs font-mono">200</code> rapidement — RoehAI retente si pas de réponse en 10s</li>
