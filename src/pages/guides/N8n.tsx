...
const n8nConfig = `// Configuration du nœud HTTP Request dans n8n
{
  ...
  "bodyParameters": {
    ...
    "context": "Lead depuis n8n avec source {{ $json.source }}"
  }
}`;
...
// 1. Webhook Trigger
// 2. Set
// 3. HTTP Request vers RoehAI
// 4. Si succès, Notion ou Airtable
// 5. Si erreur, alerte Slack`;
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="p-4 rounded-xl bg-card border border-border text-sm">
          ...
          <ul className="text-muted-foreground space-y-1.5">
            <li>Scraper de leads avec appel automatique immédiat</li>
            <li>Import CSV pour lancer une campagne d'appels en masse</li>
            <li>Intégration Airtable avec mise à jour du statut après l'appel RoehAI</li>
            <li>Webhook RoehAI vers Notion pour enregistrer les transcripts</li>
          </ul>
        </div>
      </div>
    </div>
